...
STUB(house_asid_forget_pdir)
STUB(house_clear_exit)
STUB(house_el0_clone_slot)
STUB(house_el0_exit_status)
STUB(house_el0_fault_addr)
STUB(house_el0_parked)
STUB(house_el0_register)
STUB(house_el0_set_entry)
STUB(house_el0_take_request)
STUB(house_el0_unregister)
...
STUB(house_resume_el0)
STUB(house_sched_set_quantum)
STUB(house_sched_set_runnable)
STUB(house_smp_down)
...
STUB(house_user_read)
STUB(house_user_read_bytes)
STUB(house_user_strlen)
STUB(house_user_write)
STUB(house_user_write_bytes)

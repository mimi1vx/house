...
pub unsafe extern "C" fn house_handle_user_fault(far: u64) -> i32 {
    ...
    unsafe {
        ...
        if d1 & PTE_VALID == 0 || d1 & PTE_TABLE == 0 {
            ...
            core::arch::asm!("dsb sy", options(nostack, preserves_flags));
            *l1.add(i1) = ((nl2 as u64) & !0xFFF) | PTE_VALID | PTE_TABLE;
            core::arch::asm!("dsb sy; isb", options(nostack, preserves_flags));
            d1 = *l1.add(i1);
        ...
        if d2 & PTE_VALID == 0 || d2 & PTE_TABLE == 0 {
            ...
            core::arch::asm!("dsb sy", options(nostack, preserves_flags));
            *l2.add(i2) = ((nl3 as u64) & !0xFFF) | PTE_VALID | PTE_TABLE;
            core::arch::asm!("dsb sy; isb", options(nostack, preserves_flags));
            d2 = *l2.add(i2);
